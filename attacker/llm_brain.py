...
if __name__ == "__main__":
    test_state = '{"phase":"RECON","ports":[],"vulns":[],"mission_status":"ONGOING","system_compromised":false,"attack_blocked":false}'
    brain = StrategicAgent(model_name="llama3.1")
    print("\n--- TEST BAŞLIYOR ---")
